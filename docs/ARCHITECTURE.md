...
- `fallback_context.extraction_kind`: a stable grouped category derived from `extraction_source`, such as `meta`, `jsonld`, `next_data`, `window_state`, `dom`, or `inline_html`
